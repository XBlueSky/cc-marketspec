...
- **Showcase site** — `site/` is a reference Astro app that renders this repo's `manifest.json` into a marketplace page. It's the worked example of the "manifest → site" path: downstream marketplaces can copy it.
